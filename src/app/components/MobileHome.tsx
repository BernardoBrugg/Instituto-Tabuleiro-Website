      ...
      <div className="space-y-8">
          ...
          <section className="flex-grow flex items-center w-full">
            <div className="flex flex-col items-center gap-8 w-full">
              <div className="text-center w-full">
                ...
                <p className="mt-4 max-w-xl mx-auto text-white/80 hover:text-white/90 transition-colors duration-500">
        ...
        >
          ...
          <p className="text-center text-white/80 mb-8 hover:text-white/90 transition-colors duration-500">
            O Instituto Tabuleiro foi criado em 2015. Nossa missão é auxiliar a gestão do Parque
