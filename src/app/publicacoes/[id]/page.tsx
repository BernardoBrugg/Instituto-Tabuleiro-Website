          ...
          {publication.description.length > 1000 ? (
            <div className="flex flex-col items-center">
              <Image
                ...
                width={500}
                height={400}
                className="w-full max-w-md h-80 object-cover rounded-lg mb-6"
              />
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                {publication.description.split(". ").map((sentence, index) => (
                  <p
                    key={index}
                    className="text-white/80 mb-4 hover:text-white/90 hover:scale-105 transition-colors duration-700 ease-in-out cursor-pointer"
                  >
                    {sentence}.
                  </p>
                ))}
